...
const blogConfig = [
    {
        id: "blog-8",
        title: "Open Source Stack for MLOps Platform",
        links: [
            {
                name: "article",
                url: "https://medium.com/@gosshhh9/open-source-stack-for-mlops-platform-ecaaa7b11dcd",
                icon: <SiMedium/>
            }
        ],
        image: "https://miro.medium.com/max/700/1*VKIGzmJrYBzcPlB6USx8OA.jpeg",
        description: "we will discuss a full open source stack for MLOps platform for machine learning models and explain the reasons for choosing each tool.",
        target: "_blank"
    },
    {
        id: "blog-7",
    ...
    {
        id: "blog-0",
        title: "Demand forecasting of new products launched",
        links: [
            {
                name: "article",
                url: "https://medium.com/@gosshhh9/demand-forecasting-of-new-products-launched-baa7fe405f78",
                icon: <SiMedium/>
            }
        ],
        image: "https://miro.medium.com/v2/resize:fit:720/0*sueZMchPDuKS1eyJ",
        description: "When it comes to new product launches, demand forecasting becomes even more critical as there is no historical data to rely on.",
        target: "_blank"
    }
]
